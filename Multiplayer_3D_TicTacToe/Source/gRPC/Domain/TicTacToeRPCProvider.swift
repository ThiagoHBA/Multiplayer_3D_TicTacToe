...
final class TicTacToeProvider: Tictactoe_TicTacToeProvider {
    private var session = TicTacToeRPCSession()
...
//    func connectedMessage(
//        request: Tictactoe_ConnectedMessageRequest,
//        context: GRPC.GRPCAsyncServerCallContext
//    ) async throws -> Tictactoe_ConnectedMessageResponse {
//        let response = Tictactoe_ConnectedMessageResponse()
//        return response
//    }
//    
//    func chat(
//        requestStream: GRPC.GRPCAsyncRequestStream<Tictactoe_Message>,
//        responseStream: GRPC.GRPCAsyncResponseStreamWriter<Tictactoe_Message>,
//        context: GRPC.GRPCAsyncServerCallContext
//    ) async throws {
//
//    }
